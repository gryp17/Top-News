<div id="signup-wrapper" class="row" ng-controller="signupController">
	...
	<form name="signUpForm">
		<div>
			...
			<!-- max length error -->
			<div class="error-popup hidden" data-show="signUpForm.username.$error.maxlength" data-content="Username exceeds 8 characters"></div>
		...
		<div>
			...
			<!-- email format error -->
			<div class="error-popup hidden" data-show="signUpForm.email.$error.pattern" data-content="Invalid email"></div>
			
			<!-- max length error -->
			<div class="error-popup hidden" data-show="signUpForm.email.$error.maxlength" data-content="The field exceeds 8 characters"></div>
		</div>

		<div>
			<input type="button" class="btn btn-success" ng-disabled="signUpForm.$error.required" value="Sign up" ng-click="signUp()"/>		
			<div ng-show="signUpForm.$error.required" style="color: red">All fields are required.</div>
		</div>
